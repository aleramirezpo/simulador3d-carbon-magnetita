...
treinta segundos.}
\input{tabla_fen_adimensionales}
\end{table}
...
\begin{enumerate}[leftmargin=*]
  \item \textbf{Se acaba el reactivo que se estaba consumiendo.} La hematita se
        agota literalmente: llega a cero. Una reacción sin reactivo se para
        sola.
  \item \textbf{Se llega a una frontera termodinámica.} La magnetita, en
        cambio, \emph{no} se agota: quedan \datMagnetitaFinal{} \si{\milli\gram}
        coexistiendo con \datFeo{} \si{\milli\gram} de wüstita, y hay carbono de
        sobra (\datCarbono{} \si{\milli\gram}, intacto). El gas se apoya en la
        frontera Fe$_3$O$_4$/FeO y no pasa de ahí. Esto no es agotamiento: es un
        tope, y es lo que hace que el aglomerado siga respondiendo al imán.
