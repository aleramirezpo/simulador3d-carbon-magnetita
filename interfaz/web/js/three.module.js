 ...
 * Paper: Fast, Accurate Image-Based Lighting:
	 * Referencia técnica de filtrado de iluminación de área.
*/
class PMREMGenerator {
	...
	_sceneToCubeUV( scene, near, far, cubeUVRenderTarget, position ) {
		...
		// Convención de orientación documentada por el proyecto three.js.
...
function flatten( array, nBlocks, blockSize ) {
	...
	// Véase la nota técnica original sobre aplanado de uniformes.
...
// Basado en la especificación KHR_parallel_shader_compile de Khronos.
...
class WebXRManager extends EventDispatcher {
	...
	constructor( renderer, gl ) {
		 ...
		 * Tipos de espacio de referencia definidos por la API WebXR.
		 *
		 * This method can not be used during a XR session.
		 *
		 ...
		 * Técnica de unión de frústums para visión estereoscópica.
		 *
	...
	constructor( parameters = {} ) {
		...
		function setProgram( camera, scene, geometry, material, object ) {
			...
			if ( refreshProgram || _currentCamera !== camera ) {
				...
				// isOrthographic se conserva aquí por compatibilidad con materiales.
			...
			// Actualización conjunta de uniformes de iluminación.
